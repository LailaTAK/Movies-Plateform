    ...
    >
      <div className="max-w-[450px] w-full bg-black bg-opacity-75 rounded px-8 py-14 mx-auto mt-8">
        ...
        <form onSubmit={handleSignUp}  className='flex flex-col space-y-4'>
          ...
          placeholder='John Doe' className='w-full h-[50px] bg-[#333]
          text-white rounded px-5 text-base' />
          <input type="email"
          value={email} onChange={(e)=> setEmail(e.target.value)} 
          placeholder='johndoe@gmail.com' className='w-full h-[50px] bg-[#333]
          text-white rounded px-5 text-base' />
          <input type="password" 
          value={password} onChange={(e)=> setPassword(e.target.value)}
          placeholder='Enter your password' className='w-full h-[50px] bg-[#333]
          text-white rounded px-5 text-base' />
          ...
          <button  type="submit" disabled={isLoading}
           className='w-full bg-[#e50914] text-white py-2 rounded text-base
          hover:opacity-90 cursor-pointer'>Sign Up</button>
        </form>
