  ...
  return (
    ...
    from-[#181818] via-[#232323] to-[#181818] relative overflow-hidden'>
      {!(recommendation && recommendation.length > 0 ) && (
        <img src={bgimg} className="absolute inset-0 w-full h-full object-cover opacity-20 blur-[2px]" />)}
    ...
    shadow-2xl border border-[#333] px-8 py-10 mt-4 flex flex-col items-center min-h-[480 px]'>
      <h2 className='text-3xl font-extrabold mb-8 text-center text-white tracking-tight
       drop-shadow-lg'>AI Movie Recommendation</h2>
        ...
        <div className='w-full flex flex-col flex-1'>
          ...
          <div className='grid grid-cols-1 gap-3'>
            {steps[step].options.map((opt)=> (
              ...
              className={`w-full py-3 rounded-xl border-2 transition font-semibold text-base flex items-center justify-center gap-2 focus:outline-none focus:ring-2 active:scale-95 duration-150
              focus:ring-[#e50914] shadow-sm ${inputs[steps[step].name] == opt ? "bg-[#e50914] border-[#e50914] text-white shadow-lg" : "bg-[#232323] border-[#444] text-white hover:bg-[#e50914]/80 hover:border-[#e50914]"}`}>
              {opt}
            </button>))}
          </div>
          </div>
